...
{
    [ModuleType(typeof(FbDatabase))]
    public class FbDatabaseSettings : BindableBase, IContainerSettings
    {
        ...
        {
            if (obj as FbDatabaseSettings == null) return 1;
            var set = (FbDatabaseSettings)obj;
